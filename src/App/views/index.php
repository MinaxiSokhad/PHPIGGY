<?php // echo $secret; not pass variable outside the scope 

?>
<h1><!--Home PAgeee--></h1>
<h1><?php //echo $data['title'];
    ?></h1><!-- access data from the array -> extracting array -->
<h1><?php // echo $title; //extracting specific value of array 
    ?></h1>

<?php include $this->resolve("partials/_header.php"); ?> <!-- not all the page define header page code only define this path and access it page -->
...
<section class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    ...
    <table class="table-auto min-w-full divide-y divide-gray-300 mt-6">
        ...
        <tr>
                ...
                <!-- Date -->
                <td class="p-4 text-sm text-gray-600">
                <?php echo e($transaction['formatted_date']);?></td>
                <!-- Actions -->
    ...
    <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
        ...
        <div class="hidden md:-mt-px md:flex">
            <?php foreach($pageLink as $pageNum => $query): ?>
...
<?php include $this->resolve("partials/_footer.php"); ?><!-- not all the page define footer page code only define this path and access it page  * its called partial * -->