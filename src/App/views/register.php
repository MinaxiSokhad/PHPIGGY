...
<section class="max-w-2xl mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    ...
    <form id="register" method="POST" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            ...
            <input id="email" value="<?php echo e($oldFormData['email'] ?? ''); ?>" name="email" type="email"
        ...
        <label class="block">
            ...
            <input id="age" value="<?php echo e($oldFormData['age'] ?? ''); ?>" name="age" type="number"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                placeholder="" />
        ...
        <label class="block">
            ...
            <input id="socialMediaURL" value="<?php echo e($oldFormData['socialMediaURL'] ?? ''); ?>"
            ...
            <div class="mt-2">
                <div>
                    <label class="inline-flex items-center">
                        <input id="tos" <?php echo $oldFormData['tos'] ?? false ? 'checked' : ''; ?> name="tos"
